...
java -cp oxygen/lib/saxon9ee.jar net.sf.saxon.Transform  -s:$DITAMAP -xsl:oxygen/frameworks/dita/report/report.xsl -catalog:oxygen/frameworks/dita/catalog.xml -o:metrics-report.html
